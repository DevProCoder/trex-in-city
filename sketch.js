...
function preload(){
  ...
  groundImage = loadImage("download.jpeg");
  
  cloudImage = loadImage("cloud.png");
  
  obstacle1 = loadImage("download (2).png");
  obstacle2 = loadImage("download (2).png");
  obstacle3 = loadImage("download (2).png");
  obstacle4 = loadImage("downlooad.png");
  obstacle5 = loadImage("downlooad.png");
  obstacle6 = loadImage("downlooad.png");
...
function setup() {
 ...
 console.log(message)
  ...
  ground = createSprite(5000,displayHeight-400,400,20);
